...
export const socialNetworks: socialNetworkType = {
  ...
  youku: { color: "#fd507f", category: "video_platform" },
  ...
  leakbase: { color: "#1b1c15", category: "hacking" },
  raidforums: { color: "#88748f", category: "hacking" },
  hackforums: { color: "#282828", category: "hacking" },
  guiadohacker: { color: "#2970e5", category: "hacking" },
